...
`define USER_CONFIG_GPIO_38_INIT `GPIO_MODE_USER_STD_OUTPUT
`define USER_CONFIG_GPIO_39_INIT `GPIO_MODE_USER_STD_OUTPUT
`define USER_CONFIG_GPIO_40_INIT `GPIO_MODE_USER_STD_OUTPUT
`define USER_CONFIG_GPIO_41_INIT `GPIO_MODE_USER_STD_OUTPUT
`define USER_CONFIG_GPIO_42_INIT `GPIO_MODE_USER_STD_OUTPUT
`define USER_CONFIG_GPIO_43_INIT `GPIO_MODE_USER_STD_OUTPUT
`define USER_CONFIG_GPIO_44_INIT `GPIO_MODE_USER_STD_OUTPUT
`define USER_CONFIG_GPIO_45_INIT `GPIO_MODE_USER_STD_OUTPUT
`define USER_CONFIG_GPIO_46_INIT `GPIO_MODE_USER_STD_OUTPUT
`define USER_CONFIG_GPIO_47_INIT `GPIO_MODE_USER_STD_OUTPUT
`define USER_CONFIG_GPIO_48_INIT `GPIO_MODE_USER_STD_OUTPUT
`define USER_CONFIG_GPIO_49_INIT `GPIO_MODE_USER_STD_OUT_MONITORED
`define USER_CONFIG_GPIO_50_INIT `GPIO_MODE_USER_STD_OUT_MONITORED
`define USER_CONFIG_GPIO_51_INIT `GPIO_MODE_USER_STD_OUT_MONITORED
`define USER_CONFIG_GPIO_52_INIT `GPIO_MODE_USER_STD_OUT_MONITORED
`define USER_CONFIG_GPIO_53_INIT `GPIO_MODE_USER_STD_OUT_MONITORED
`define USER_CONFIG_GPIO_54_INIT `GPIO_MODE_USER_STD_OUT_MONITORED
`define USER_CONFIG_GPIO_55_INIT `GPIO_MODE_USER_STD_OUT_MONITORED
`define USER_CONFIG_GPIO_56_INIT `GPIO_MODE_MGMT_STD_INPUT_NOPULL
`define USER_CONFIG_GPIO_57_INIT `GPIO_MODE_MGMT_STD_INPUT_NOPULL
